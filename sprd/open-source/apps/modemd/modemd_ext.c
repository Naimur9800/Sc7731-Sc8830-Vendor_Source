...
extern int td_modem_state;
extern int lte_modem_state;
extern pthread_mutex_t td_state_mutex;
extern pthread_mutex_t lte_state_mutex;
extern pthread_cond_t  td_cond;
extern pthread_cond_t  lte_cond;
