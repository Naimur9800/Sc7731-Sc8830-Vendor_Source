...
struct awb_opt_info {
	struct isp_awb_rgb_l gldn_stat_info;
	struct isp_awb_rgb_l rdm_stat_info;
};

struct awb_init_param {
	uint32_t base_gain;
	struct isp_awb_size stat_img_size;
	struct awb_opt_info opt_info;
	struct isp_awb_ct_info ct_info;
...
struct isp_awb_calc_param {
	struct isp_awb_stat awb_stat;
	enum awb_envi_id envi_id[2];
...
uint32_t awb_set(awb_handle_t handle, uint32_t cmd, void *in_param, void *out_param);
uint32_t awb_get(awb_handle_t handle, uint32_t cmd, void *in_param, void *out_param);
/*------------------------------------------------------------------------------*
*				Compiler Flag					*
*-------------------------------------------------------------------------------*/
#ifdef __cplusplus
