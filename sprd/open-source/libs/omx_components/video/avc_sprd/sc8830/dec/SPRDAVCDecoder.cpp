...
SPRDAVCDecoder::SPRDAVCDecoder(
    ...
    ALOGI("Construct SPRDAVCDecoder, this: %p", (void *)this);
...
SPRDAVCDecoder::~SPRDAVCDecoder() {
    ALOGI("Destruct SPRDAVCDecoder, this: %p", (void *)this);
...
bool SPRDAVCDecoder::handleCropRectEvent(const CropParams *crop) {
    if (mFrameWidth != crop->cropOutWidth ||
            mFrameHeight != crop->cropOutHeight) {
...
void SPRDAVCDecoder::updatePortDefinitions(bool updateInputSize) {
    OMX_PARAM_PORTDEFINITIONTYPE *outDef = &editPortInfo(kOutputPortIndex)->mDef;
    outDef->format.video.nFrameWidth = mFrameWidth;
    outDef->format.video.nFrameHeight = mFrameHeight;
