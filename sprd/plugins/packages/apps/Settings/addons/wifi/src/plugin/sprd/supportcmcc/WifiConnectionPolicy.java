...
public class WifiConnectionPolicy extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        if (WifiManager.SUPPORT_CMCC == false) {
            return;
        }
        // initialize values
        ...
        else if (action.equals(WifiManager.ALARM_FOR_CONNECT_WIFI_ACTION)) {
            setConnectWifiAlarm(context);
        } else if (action.equals(WifiManager.ALARM_FOR_DISCONNECT_WIFI_ACTION)) {
    ...
    public static void setMobileToWlanPolicy(Context context, int value) {
        Settings.Global.putInt(context.getContentResolver(), WifiManager.WIFI_MOBILE_TO_WLAN_POLICY, value);
    ...
    public static int getMobileToWlanPolicy(Context context) {
        int value =Settings.Global.getInt(context.getContentResolver(),
               WifiManager.WIFI_MOBILE_TO_WLAN_POLICY, MOBILE_TO_WLAN_AUTO);
        return value;
    }
