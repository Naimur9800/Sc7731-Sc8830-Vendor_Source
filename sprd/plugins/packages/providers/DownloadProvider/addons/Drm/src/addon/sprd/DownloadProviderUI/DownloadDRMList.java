...
//                WindowManager.LayoutParams.FLAG_FULLSCREEN);
      ...
      dialog.setOnDismissListener(new OnDismissListener() {
        ...
        public void onDismiss(DialogInterface dialog) {
            // TODO Auto-generated method stub
            if (!DownloadDRMList.this.isFinishing()){
                DownloadDRMList.this.finish();
                }
        }
    });
    ...
    private void installDrmSaveRights(final int drmType, final Context context, final String path, final String mimeType){
        ...
        new AsyncTask<Void, Void, Integer>() {
            int result = -1;
            String destinationFile = "/storage/sdcard0/" + "drmDownload";
            @Override
            protected void onPostExecute(Integer result) {
                ...
                if (mErrorDrm){
                    ...
                    if (result == DrmManagerClient.ERROR_NONE){
                        ...
                        Toast.makeText(context, getApplicationContext().getText(R.string.drm_file_download_not_finished), Toast.LENGTH_SHORT).show();
                    }
                    else{
            ...
            protected Integer doInBackground(Void... params) {
                ...
                if (!queryDownloadStatusSuccess(context, path)){
                ...
                if (drmType == DrmStore.DrmObjectType.CONTENT){
                    ...
                    result = DownloadDrmHelper.processConvertDrmInfo(context, path, mimeType, destinationFile);
