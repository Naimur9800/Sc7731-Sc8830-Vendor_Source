...
import com.android.phone.CallLogger;
...
import com.android.services.telephony.plugin.PstnIncomingCallNotifierUtils;
...
public class AddonPstnIncomingCallNotifierUtils extends PstnIncomingCallNotifierUtils implements
     AddonManager.InitialCallback {

    private static final String LOGTAG = "AddonPstnIncomingCallNotifierUtils";
	...
	private static final boolean SUPPORT_CALLFIREWALL = !SystemProperties
			.getBoolean("ro.callfirewall.disabled", false);

    public AddonPstnIncomingCallNotifierUtils() {
	...
	public static boolean checkIsBlockNumber(Context context, String number) {
		...
		int block_type;
		String[] columns = new String[] { BlackColumns.BlackMumber.MIN_MATCH,
	...
	public static class BlackColumns {
		...
		public static final class BlackMumber implements BaseColumns {
			...
			public static final String BLOCK_TYPE = "block_type"; // 0 block call, 1 block message,2 block call and message
    ...
    public void plugin_phone(Connection connection,Call call){
        CallManager mCM = new CallManager();

						final String inComingNumber = connection.getAddress();
						if (SUPPORT_CALLFIREWALL
