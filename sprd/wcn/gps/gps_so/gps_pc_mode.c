...
static char *version = "VERSION: 2015-07-22\r\n";
...
int eut_parse(int data,int sub_data, char *rsp)
{
	...
	{	
		...
		{
			if((gps_mode == 50002)||(gps_mode == 50004)||(gps_mode == 50001))
			{
				pGpsface->delete_aiding_data(125);	// cold start
				gps_mode = 0;
			}
		}
